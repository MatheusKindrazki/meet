...
const server_url = process.env.NODE_ENV === 'production' ? 'https://meet.kindrazki.dev' : "http://localhost:4001"
			...
			<div>
				{this.state.askForUsername === true ?
					<div>
						<div style={{background: "white", width: "30%", height: "auto", padding: "20px", minWidth: "400px",
								textAlign: "center", margin: "auto", marginTop: "50px", justifyContent: "center"}}>
							<p style={{ margin: 0, fontWeight: "bold", paddingRight: "50px" }}>Adicione seu nome</p>
							<Input placeholder="Username" value={this.state.username} onChange={e => this.handleUsername(e)} />
							<Button variant="contained" color="primary" onClick={this.connect} style={{ margin: "20px" }}>Entrar</Button>
						</div>
					...
					<div>
						...
						<Modal show={this.state.showModal} onHide={this.closeChat} style={{ zIndex: "999999" }}>
							...
							<Modal.Footer className="div-send-msg">
								...
								<Button variant="contained" color="primary" onClick={this.sendMessage}>Enviar</Button>
							</Modal.Footer>
						</Modal>
